...
// Parse SubDL search response (inspired by a4kSubtitles)
function parseSubdlSearchResponse(data, videoId, infoHash) {
    ...
    for (const item of data.subtitles) {
        ...
        // Calculate score based on a4kSubtitles approach
    ...
    console.log(`[subtitleMatcher] SubDL parsed ${subtitles.length} Turkish subtitles`);
...
function parsePodnapisiJsonResponse(data, videoId, infoHash) {
    ...
    for (const item of data.data) {
        ...
        const isTurkish = langCode === 'tr' || langCode === 'tur' || langCode === 'turkish';
